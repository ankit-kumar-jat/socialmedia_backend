    ...
    try {
        ...
        if (user) {
            ...
            if (oldToken) {
                ...
                sendEmail(`<p><strong>Password Reset Link</strong>: <a href="https://linkbook.ankitkumarjat.me/forhetpass/${token.resetPasswordToken}:${token.tokenId}">https://linkbook.ankitkumarjat.me/forhetpass/${token.resetPasswordToken}:${token.tokenId}</a></p>`, user.email, 'Password reset token');
